...
void mainT()
{
	...
	map<int, gameTree*> genreMap = ReadData("Data");

    //Search for top 5 games
    vector<DataNode> outputGames = findTop(inputGenMap, genreMap);
...
vector<DataNode> findTop(map<int, string> genres, map<int, gameTree*> &genreMap)
{
